...
class _shivState extends State<shiv> {
  ...
  String s1 = 'https://firebasestorage.googleapis.com/v0/b/authntication-f92cd.appspot.com/o/Garages%2FShiv%2Fs1.jpg?alt=media&token=74315e36-c903-4604-8142-67efec5c2c02';
  String s2 = 'https://firebasestorage.googleapis.com/v0/b/authntication-f92cd.appspot.com/o/Garages%2FShiv%2Fs2.jpg?alt=media&token=74315e36-c903-4604-8142-67efec5c2c02';
                        ...
                        Column(
                            ...
                            children: [
                              Container(
                                height: 50,
                                width: double.infinity,
                                child: Text('Shiv Moters',style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
                                padding:EdgeInsets.all(10),
                              ),
                              Container(
                                  height: 40,
                                  padding:EdgeInsets.all(10),
                                  child: Text('Bhavnagar city, Bhavnagar',style: TextStyle(fontSize: 15,color: Colors.grey),)
                              ),
                              Container(
                                  height: 50,
                                  padding:EdgeInsets.all(10),
                                  child: Text('Open untill 9am to 9pm',style: TextStyle(fontSize: 20,color: Colors.green))
                              ),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  height: 40,
                                  padding: EdgeInsets.all(10),
                                  child: Text('Cash , Phonepay ',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                                ),
                              ],
                            )
                          ],
